...
Mesh::Mesh(const HalfedgeMesh& mesh, BSDF* bsdf, BSSRDF* bssrdf = NULL) {
...
SphereObject::SphereObject(const Vector3D& o, double r, BSDF* bsdf, BSSRDF* bssrdf = nullptr) {
...
BSSRDF* SphereObject::get_bssrdf() const {
  return bssrdf;
}
