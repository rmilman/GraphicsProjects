...
void Application::render() {
  ...
  switch (mode) {
    case EDIT_MODE:
      ...
      // if (visualize_points) pathtracer->visualize_surface_points();
      if (show_hud) draw_hud();
      break;
    case VISUALIZE_MODE:
    case POINT_MODE:
    case VISUALIZE_OCT_MODE:
      if (show_coordinates) draw_coordinates();
    case RENDER_MODE:
  ...
  switch (mode) {
    case RENDER_MODE:
      if (event == EVENT_PRESS) {
        ...
        case 'o': case 'O':
            pathtracer->stop();
            pathtracer->start_visualizing_oct();
            mode = VISUALIZE_OCT_MODE;
            break;
        case 's': case 'S':
    ...
    case VISUALIZE_MODE:
        ...
        switch(key) {
          ...
          case 'p': case 'P':
            pathtracer->stop();
            pathtracer->start_visualizing_points();
            mode = POINT_MODE;
