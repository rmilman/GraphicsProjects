...
struct Triangle : SVGElement {
  ...
  virtual Color color(Vector2D xy, Vector2D dx = Vector2D(), Vector2D dy = Vector2D(), 
...
struct ColorTri : Triangle { 
  ...
  Color color(Vector2D xy, Vector2D dx = Vector2D(), Vector2D dy = Vector2D(), 
